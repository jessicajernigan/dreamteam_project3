...
db.once('open', async () => {
	...
	const songs = await Song.insertMany([
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/hospital-revival/8th_of_January-2.mp3'
		},
		{
			title: "Ain't Nobody's Bizness",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/hospital-revival/Aint_Nobodys_Bizness-2.mp3'
		},
		{
			title: 'Hash Smugglers Blues',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/hospital-revival/Hash_Smugglers_Blues.mp3'
		},
		{
			title: '8th of january',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/btn-the-chaps/8th_of_January.mp3'
		},
		{
			title: "I'm Not Drunk, You Are",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/btn-the-chaps/Im_Not_Drunk_You_Are.mp3'
		},
		{
			title: 'All New Blooming',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/greylizards/All_New_Blooming.mp3'
		},
		{
			title: 'Wirklich Wichtig',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/greylizards/Wirklich_Wichtig-2.mp3'
		},
		{
			title: 'A la Luz',
		...
		},
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/taking_back_autumn/Sandpaper_Tigers.mp3'
		},
		{
			title: 'Stoned Funghi',
		...
		},
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/limp_compass/Time_is_On_My_Side.mp3'
		},
		{
			title: 'Sandpaper Tigers',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/limp_compass/Two_Sandpaper_Tigers.mp3'
		},
		{
			title: 'Vuelve a la Luz',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/limp_compass/Vuelve_a_la_Luz.mp3'
		},
		{
			title: 'Lateen Sails',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/apples-n-plums/Lateen_Sails.mp3'
		},
		{
			title: 'Le Sang',
		...
		},
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/apples-n-plums/Two_Penceresi_Yola_Karsi.mp3'
		},
		{
			title: 'Amsterdam',
		...
		},
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/rupert/Funky_Banane_Nightclub.mp3'
		},
		{
			title: 'Hash Smugglers Blues',
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/verucappleback/Hash_Smugglers_Blues_2.mp3'
		},
		{
			title: 'Lateen Sails',
		...
		{
			title: "Ain't Nobody's Bizness",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/lucy-trout/Aint_Nobodys_Bizness.mp3'
		},
		{
			title: "All New Blooming",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/melvin_chelmy/All_New_Blooming_2.mp3'
		},
		{
			title: "Kielokaz",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/marlowe_crawley/Two Kielokaz.mp3'
		},
		{
			title: "Any Way That You Want Me",
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/musharraf/Any_Way_That_You_Want_Me.mp3'
		},
		{
			title: "Rain",
		...
		},
		{
			...
			songUrl: 'http://d28dtfvuvlqgls.cloudfront.net/sgtscrumpleton/Dog_Soldier_Stand_Down.mp3'
		},
	])
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/hospital-revival/busker-peeps-3.jpg',
		location: 'Austin, TX',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[3]._id, vibes[6]._id, vibes[1]._id],
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/btn-the-chaps/busker-peeps-1.jpg',
		location: 'Austin, TX',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[3]._id, vibes[2]._id],
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/greylizards/buskr-one-man-band.jpg',
		location: 'Austin, TX',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/taking_back_autumn/busker-gal-2.jpg',
		location: 'Austin, TX',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[3]._id],
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/apples-n-plums/busker-guy-10.jpg',
		location: 'Seneca, SC',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/verucappleback/busker-gal-3.jpg',
		location: 'Spokane, WA',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[3]._id],
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/marlowe_crawley/busker-guy-2.jpg',
		location: 'Albany, NY',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[13]._id],
	...
	await Creator.create({
		...
		imgUrl: 'http://d28dtfvuvlqgls.cloudfront.net/sgtscrumpleton/busker-guy-6.jpg',
		location: 'Austin, TX',
		bio:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, doloremque? Doloribus quidem facere, non natus quas optio obcaecati distinctio amet aliquam magni expedita soluta iure neque! Voluptas excepturi beatae hic dolorum laborum ad consectetur deserunt modi enim eum assumenda, nihil quia eveniet? Ducimus dicta porro ab totam eum iusto et.',
		vibes: [vibes[3]._id],
